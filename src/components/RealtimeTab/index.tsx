    ...
    >
      ...
      <div className="flex flex-col gap-1.5 p-2 roomy:gap-2 roomy:p-3">
        ...
        {/* 地震発生時刻（`Earthquake/OriginTime`）。**緊急地震速報はここだけ発現時刻へ揃えていない。**
            **この値は表示専用ではない** —— 発生時刻からの経過で決まる値（予報円・自動解除ほか）と、
            どれを「最新」とみなすかの並び順も同じ値を読む。据え置きの根拠・読む場所の一覧・実測は
