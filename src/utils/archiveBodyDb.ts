 ...
 * 展開比は実測で ×11.5／×17.3／×18.1 あり、遡り幅に上限があった頃に測れた 58 日ぶんは
 ...
 * 地震カードは窓 7 日ずつ遡り、リプレイは任意の過去日を再生できるので、**どちらも触る日数に
 * 上限が無い**（カードの遡りも在庫の端まで届く）—— 録画で何百日を通しても収まる幅を採った。
 */
 ...
 * 上限があった頃の 58 日ぶんで gz 合計 2.3MB、地震の多い日でも 1 本 1.46MB。
