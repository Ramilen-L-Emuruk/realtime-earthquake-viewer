 ...
 * - `hold`: 電文の受信そのもの・ユーザー操作・揺れ検知など、読み上げを持たない経路
 */
export type TabHoldSource = 'speech' | 'idleRevert' | 'hold'
 ...
 * 例外が 2 つあり、どちらも保持の側が譲る（下記）——揺れ検知の保持は読み上げの有無に関わらず
 * 他の移動を妨げず、アイドル復帰の保持は読み上げ追従を妨げない。
 *
