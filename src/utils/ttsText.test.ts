...
import { earthquakeToText, earthquakeToSegments, createQuakeSpokenState, applySpokenRefs, eewIntensityText, lpgmToText, tsunamiToText, tsunamiArrivalToText, tsunamiObservationUpdateToText, tsunamiAreaGradeChangeToText, type TtsRegionOptions, type QuakeSpokenState } from './ttsText'
