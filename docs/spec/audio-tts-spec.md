...
- 2026-08-20: 区分の前置き（「警報。」）をその EEW で初めて伝えるときだけに絞り、あわせて EEW が
  予想震度の確定を待っている間も EEW を最優先として扱うようにした（いずれも理由は §6）。前者は
  値を読み直すだけの報にも毎回「警報」が挟まっていたため、後者は震源を読み終えた直後に地震情報が
  滑り込み、第 2 フェーズに必ず切られていたため
